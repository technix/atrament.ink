...
Якщо ваш сценарій стає занадто великим, ви можете розділити його на декілька файлів. Один з них стає головним файлом сценарію і має містити оператори `INCLUDE`. Під час компіляції сценарію Ink ці оператори `INCLUDE` заміняються контентом файлів, вказаних ях їхні параметри.
