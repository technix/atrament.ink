...
Каталог `resources` містить додаткові ресурси для Atrament Web UI: шрифти, переклади, стилі CSS, теми оформлення та зовнішні функції. Ці файли під час публікації гри будуть вбудовані в сторінку або застосунок.
