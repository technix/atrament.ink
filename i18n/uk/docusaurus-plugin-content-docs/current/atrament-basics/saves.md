...
Атрамент підтрибує автоматичне збереження гри, контрольні точки та користувацькі збереження.
...
Початкове значення змінної, що зберігається, буде замінене на збережене значення, якщо воно існує. Коли така змінна отримує нове значення, воно буде збережено автоматично.
