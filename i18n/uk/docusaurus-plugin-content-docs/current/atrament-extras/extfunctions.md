...
Файл `resources/externals/utilities.js.txt` містить реалізацію різних корисних зовнішніх функцій. Для того, щоб їх можна було використовувати в вашому проекті, зробіть наступне:
1. Переіменуйте цей файл в `utilities.js`.
2. Додайте в ваш Ink-сценарій рядки з декларацією потрібних функцій, вказані на початку файлу (наприклад, `EXTERNAL UPPERCASE(str)`).
