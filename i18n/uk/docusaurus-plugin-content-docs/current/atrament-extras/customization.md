...
Щоб додати до застосунку шрифт з сайту [Google Fonts](https://fonts.google.com/), запустіть в терміналі наступну команду, вказавши в лапках назву шрифта, наприклад:

```
npm run download-google-font "IBM Plex Sans"
```

Ця команда скачає шрифт в підкаталог `resources/fonts` з назвою шрифта та створить всі необхідні CSS та JS файли.

### Додавання власних шрифтів

Щоб додати власний шрифт до застосунку, створіть новий каталог в каталозі `resources/fonts` з такими файлами:
...
Щоб видалити шрифт з застосунку, видаліть каталог з цим шрифтом з каталогу `resources/fonts`.
