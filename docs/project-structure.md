...
The `examples` folder contain several Ink scripts as a reference. You may replace `root/game` content folder with contents of any of the example folders to run these examples in Atrament.

## Atrament engine code

The `src` folder contains Atrament UI engine code. Usually you do not need to modify it.
